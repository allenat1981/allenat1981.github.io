...
# 設定多版本 PHP 的 VirtualHost

若要替不同的 VirtualHost 設定不同版本的 PHP，可以使用 PHP-FPM

## 目錄

- [設定多版本 PHP 的 VirtualHost](#設定多版本-php-的-virtualhost)
  - [目錄](#目錄)
  - [參考資料](#參考資料)
  - [情境說明](#情境說明)
  - [設定流程](#設定流程)
    - [將 packages.sury.org/php 加入 apt sources.list](#將-packagessuryorgphp-加入-apt-sourceslist)
    - [安裝不同版本的 PHP-FPM](#安裝不同版本的-php-fpm)
    - [替不同的 VirtualHost 設定不同版本的 PHP-FPM](#替不同的-virtualhost-設定不同版本的-php-fpm)
    - [補充：切換 php-cli 版本](#補充切換-php-cli-版本)
    - [補充：Rocky Linux 參考](#補充rocky-linux-參考)
