...
2. 要運行的腳本若位於 `app/console/my_php_script.php`。

則在 bash 下輸入

```bash
# 因為 container_name 有 -，所以用 'perfumer-php'

docker exec -it 'perfumer-php' php /var/www/html/app/console/my_php_script.php
```
